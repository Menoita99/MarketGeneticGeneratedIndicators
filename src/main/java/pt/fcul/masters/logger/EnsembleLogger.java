...
@Log
@Data
public class EnsembleLogger<I, O extends Comparable<? super Double>> {
	...
	public EnsembleLogger(GpProblem<I> problem, EngineConfiguration<ProgramGene<I>, Double> configuration) {
