...
public enum ComplexVectorialGpOP  implements Op<ComplexVector>, Serializable {
	 ...
	 */
	GT_THEN_REAL("GT_THEN_REAL" ,2, v -> v[0].realMean() > v[1].realMean() ? ComplexVector.of(1) : ComplexVector.of(0)), 
	
	GT_THEN_COMPLEX("GT_THEN_COMPLEX" ,2, v -> v[0].complexMean() > v[1].complexMean() ? ComplexVector.of(1) : ComplexVector.of(0))
	;
