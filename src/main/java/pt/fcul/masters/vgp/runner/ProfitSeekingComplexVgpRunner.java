...
//			ComplexVectorTable table = new ComplexVectorTable(Market.USD_JPY,TimeFrame.H1,LocalDateTime.of(2012, 1, 1, 0, 0),VECTOR_SIZE, new DynamicDerivativeNormalizer(250));
			ComplexVectorTable table = ComplexVectorTable.fromCsv(new File("C:\\Users\\Owner\\Desktop\\GP_SAVES\\ProfitSeekingVGP\\USD_JPY H1 2012_1_1_ 0_0 VGP_50 DynamicStepNormalizer_250.csv").toPath());
